    ...
    return(
        <>
         <div className="flex justify-between bg-orange-500 shadow-lg">
             <img data-testid="logo" className="h-20 p-2"  src="https://t3.ftcdn.net/jpg/02/41/30/72/360_F_241307210_MjjaJC3SJy2zJZ6B7bKGMRsKQbdwRSze.jpg"  alt="image"></img>
             <ul className="flex py-6">
                ...
                <Link to="/cart">
                  <li className="px-3 text-white hover:text-gray-300 " data-testid="cart-items">cart - {cartItems.length}</li>
                </Link>
